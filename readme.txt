2020年01月13日
升级版本为filesync-v1.1.5
更新内容
1.添加使用帮助模式, 当最后一个传参带是--help或者help的时候, 显示使用帮助

2020年01月13日
升级版本为filesync-v1.1.4
更新内容
1.加入多线程同步机制,提高同步速度,采用宏WNH_FILESYNC_CLIENT_SYNC_THREADS_NUM来定义客户端同步使用线程数:默认为4

2020年01月08日
升级版本为filesync-v1.1.3
更新内容
1.control端添加查看同步完成任务列表和查看等待公布任务列表功能
