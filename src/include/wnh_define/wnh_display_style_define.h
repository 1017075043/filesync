...
#define WNH_COLOR_RESET         "\033[0m"               //恢复默认
#define WNH_COLOR_BLACK         "\033[30m"              //黑色
#define WNH_COLOR_RED           "\033[31m"              //红色
#define WNH_COLOR_GREEN         "\033[32m"              //绿色
#define WNH_COLOR_YELLOW        "\033[33m"              //黄色
#define WNH_COLOR_BLUE          "\033[34m"              //蓝色
#define WNH_COLOR_MAGENTA       "\033[35m"              //品红色
#define WNH_COLOR_CYAN          "\033[36m"              //青色
#define WNH_COLOR_WHITE         "\033[37m"              //白色
#define WNH_COLOR_BOLDBLACK     "\033[1m\033[30m"       //粗体黑色
#define WNH_COLOR_BOLDRED       "\033[1m\033[31m"       //粗体红色
#define WNH_COLOR_BOLDGREEN     "\033[1m\033[32m"       //粗体绿色
#define WNH_COLOR_BOLDYELLOW    "\033[1m\033[33m"       //粗体黄色
#define WNH_COLOR_BOLDBLUE      "\033[1m\033[34m"       //粗体蓝色
#define WNH_COLOR_BOLDMAGENTA   "\033[1m\033[35m"       //粗体品红色
#define WNH_COLOR_BOLDCYAN      "\033[1m\033[36m"       //粗体青色
#define WNH_COLOR_BOLDWHITE     "\033[1m\033[37m"       //粗体白色
