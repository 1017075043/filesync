...
bool wnh_filesync_control::show_server_license_info(const string & license_info) //显示许可信息
{
    ...
    string serial_number_title = format_string_centre_fill("产品序列号", 35, ' ');
    string file_path_title = format_string_centre_fill("许可文件路径", 20, ' ');
    string begin_time_title = format_string_centre_fill("许可生成时间", 24, ' ');
    string end_time_title = format_string_centre_fill("许可到期时间", 24, ' ');
    string all_time_title = format_string_centre_fill("许可有效期", 20, ' ');
    string remaining_time_title = format_string_centre_fill("许可剩余有效期", 20, ' ');
    serial_number = format_string_centre_fill(serial_number, 35, ' ');
    file_path = format_string_centre_fill(file_path, 109, ' ');
    begin_time = format_string_centre_fill(begin_time, 24, ' ');
    end_time = format_string_centre_fill(end_time, 24, ' ');
    all_time = format_string_centre_fill(all_time + "天", 20, ' ');
    remaining_time = format_string_centre_fill(remaining_time + "天", 20, ' ');
