...
unsigned long wnh_filesync_server::get_license_info() //获取许可信息
{
    ...
    WNHINFO("lic.file_path:" << lic.file_path << "lic.begin_time:" << lic.begin_time << "lic.end_time:" << lic.end_time << "lic.all_time" << lic.all_time << "lic.remaining_time:" << lic.remaining_time << ",  lic.serial_number:" <<  lic.serial_number);
