inline bool wnh_tcp_client::accept_download_file_error_stop_info(const string info) //接收下载文件错误结束信息
{
...
inline bool wnh_tcp_client::accept_download_file_size_info(const string info, unsigned long & file_size) //接收下载文件大小信息
{
...
inline bool wnh_tcp_client::accept_download_file_complete_info(const string info) //接收下载文件完成信息
{
...
inline bool wnh_tcp_client::accept_download_file_content_start_info(const string info) //接收开始下载文件内容信息
{
...
inline bool wnh_tcp_client::accept_download_file_content_stop_info(const string info) //接收结束下载文件内容信息
{
...
inline bool wnh_tcp_client::accept_download_file_content_info(const string info, const unsigned long & file_size, const string & temp_file_name) //接收下载文件内容信息
{
...
inline bool wnh_tcp_client::send_apply_download_file_info(const string file_name) //发送请求文件下载信息
{
    string info;
