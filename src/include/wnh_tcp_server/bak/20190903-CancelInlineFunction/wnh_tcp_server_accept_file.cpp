inline bool wnh_tcp_server::accept_start_send_file_info(const int nfp, const string info) //接收开始发送文件信息
{
...
inline bool wnh_tcp_server::accept_end_send_file_info(const int nfp, const string info) //接收结束发送文件信息
{
...
inline bool wnh_tcp_server::accept_start_send_file_content_info(const int nfp, const string info) //接收开始发送文件内容信息
{
...
inline bool wnh_tcp_server::accept_end_send_file_content_info(const int nfp, const string info) //接收结束发送文件内容信息
{
...
inline bool wnh_tcp_server::accept_file_size_info(const int nfp, const string info, long long & file_size) //接收文件大小信息
{
...
inline bool wnh_tcp_server::accept_file_name_info(const int nfp, const string info, string & name) //接收文件名字信息
{
...
bool wnh_tcp_server::accept_file_content(const int nfp, const string info, const string file_name) //接收一个文件内容
{
    ...
    while(survival_id)
    {
        ...
        accept_info(nfp, info_bin, info_size);
        //  if(info_size == 0)
        //  {
        //      delete []info_bin;
        //      file_info.close();
