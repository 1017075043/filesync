#ifndef __wnh_unsigned_long_string_one_list__
#define __wnh_unsigned_long_string_one_list__
...
class wnh_unsigned_long_string_one_list : public wnh_base_class
{
public:
    struct Node{
        int key;
...
public:
    ...
    wnh_unsigned_long_string_one_list();
    ~wnh_unsigned_long_string_one_list();
